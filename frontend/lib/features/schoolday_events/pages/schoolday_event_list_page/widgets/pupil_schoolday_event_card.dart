...
import 'package:schuldaten_hub/features/schoolday_events/services/schoolday_event_api_service.dart';
                              ...
                              ? Provider<DocumentImageData>.value(
                                  ...
                                  value: DocumentImageData(
                                      documentTag:
                                          '${schooldayEvent.processedFileId}',
                                      documentUrl:
                                          '${locator<EnvManager>().env.value.serverUrl}${SchooldayEventApiService().getSchooldayEventProcessedFileUrl(schooldayEvent.schooldayEventId)}',
                                      size: 70),
                        ...
                        child: schooldayEvent.fileId != null
                            ? Provider<DocumentImageData>.value(
                                ...
                                value: DocumentImageData(
                                    ...
                                    documentUrl:
                                        '${locator<EnvManager>().env.value.serverUrl}${SchooldayEventApiService().getSchooldayEventFileUrl(schooldayEvent.schooldayEventId)}',
                                    size: 70),
                                child: const DocumentImage(),
                              )
                            : SizedBox(
