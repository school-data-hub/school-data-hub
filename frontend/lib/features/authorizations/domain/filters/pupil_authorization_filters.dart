...
Map<AuthorizationFilter, bool> initialAuthorizationFilterValues = {
...
class AuthorizationFilterManager {
  final _authorizationFilterState =
      ValueNotifier<Map<AuthorizationFilter, bool>>(
          initialAuthorizationFilterValues);
  ValueListenable<Map<AuthorizationFilter, bool>>
      get authorizationFilterState => _authorizationFilterState;

  AuthorizationFilterManager();

  resetFilters() {
    _authorizationFilterState.value = {...initialAuthorizationFilterValues};
  ...
  void setFilter(
    ...
    for (AuthorizationFilterRecord record in authorizationFilters) {
      _authorizationFilterState.value = {
        ..._authorizationFilterState.value,
