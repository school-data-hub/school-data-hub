...
class Pupil(db.Model):
    ...
    pupil_schoolday_events = db.relationship('SchooldayEvent', back_populates='schoolday_event_pupil',
                                       cascade="all, delete-orphan")
    #- TO-DO: DOUBLE CHECK DELETE ORPHAN
    support_goals = db.relationship('SupportGoal', back_populates='pupil',
                                 cascade="all, delete-orphan") 
    competence_goals = db.relationship('CompetenceGoal', back_populates='pupil',
                                cascade='all, delete-orphan')
    support_category_statuses = db.relationship('SupportCategoryStatus', back_populates='pupil',
                                            cascade="all, delete-orphan")
