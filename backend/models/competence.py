...
class Competence(db.Model):
    ...
    competence_checks = db.relationship(
        "CompetenceCheck", back_populates="competence_check"
    )
...
class CompetenceGoal(db.Model):
    ...
    competence_id = db.Column(
        "competence_id", db.Integer, db.ForeignKey("competence.id")
    )
...
class CompetenceCheck(db.Model):
    ...
    competence_check_files = db.relationship(
        "CompetenceCheckFile",
        back_populates="competence_check",
...
class CompetenceCheckFile(db.Model):
    ...
    competence_check = db.relationship(
        "CompetenceCheck", back_populates="competence_check_files"
    )
...
class CompetenceReport(db.Model):
    ...
    __table_args__ = (
        db.UniqueConstraint(
            "pupil_id", "school_semester_id", name="uq_pupil_school_semester"
        ),
    )
