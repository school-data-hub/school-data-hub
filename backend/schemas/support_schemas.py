...
class SupportGoalCheckInSchema(Schema):
    ...
    class Meta:
        fields = ('comment', 'goal_id', 'achieved')
...
class SupportGoalCheckSchema(Schema):
    ...
    achieved = fields.Integer()
    class Meta:
        fields = ('created_by', 'created_at', 'comment', 'goal_id', 'check_id', 'achieved')
...
class SupportGoalInSchema(Schema):
    ...
    class Meta:
        fields = ('goal_id','support_category_id', 'created_by', 
...
class SupportGoalSchema(Schema):
    ...
    class Meta:
        fields = ('goal_id', 'pupil_id', 'support_category_id', 'created_by', 
                  'created_at', 'achieved', 'achieved_at', 'description',
