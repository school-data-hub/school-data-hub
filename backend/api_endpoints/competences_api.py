...
@competence_api.doc(
    security="ApiKeyAuth",
    tags=["Competence"],
    summary="Get competence list as a flat JSON",
)
@token_required
...
@competence_api.doc(
    security="ApiKeyAuth", tags=["Competence"], summary="Post new competence"
)
@token_required
...
@competence_api.output(competence_flat_schema)
@competence_api.doc(
    security="ApiKeyAuth", tags=["Competence"], summary="Patch new competence"
)
@token_required
...
@competence_api.doc(
    security="ApiKeyAuth", tags=["Competence"], summary="Delete competence"
)
@token_required
