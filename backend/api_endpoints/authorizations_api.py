...
from helpers.db_helpers import get_authorization_by_id, get_authorization_by_name, get_pupil_by_id
...
def add_authorization_group(current_user, json_data):
    ...
    for pupil_id in pupil_id_list:
        ...
        if pupil is not None:
            ...
            comment = None
            created_by = None
            new_pupil_authorization = PupilAuthorization( origin_authorization=origin_authorization,
...
@authorization_api.output(authorization_schema)
@authorization_api.doc(security='ApiKeyAuth', tags=['Authorizations'], summary='Get an authorization by ID')
@token_required
