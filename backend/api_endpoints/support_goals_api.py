...
from helpers.db_helpers import get_pupil_by_id, get_support_category_by_id, get_support_goal_by_id
...
support_goals_api = APIBlueprint('support_goals_api', __name__, url_prefix='/api/support_goals')
...
@support_goals_api.doc(security='ApiKeyAuth', tags=['Support Goals'], summary='Post a goal for a given support gategory')
@token_required
def add_goal(current_user, internal_id, json_data):
    ...
    new_goal = SupportGoal(pupil_id, goal_category_id, goal_id, created_by, created_at, achieved,
...
@support_goals_api.doc(security='ApiKeyAuth', tags=['Support Goals'], summary='Patch a goal for a given support gategory from a given pupil')
@token_required
...
@support_goals_api.output(pupil_schema)
@support_goals_api.doc(security='ApiKeyAuth', tags=['Support Goals'], summary='Delete a goal for a given support gategory from a given pupil')
@token_required
...
@support_goals_api.output(pupil_schema)
@support_goals_api.doc(security='ApiKeyAuth', tags=['Support Goal Checks'], summary='Post a check for a given support goal from a given pupil')
@token_required
def add_goalcheck(current_user, goal_id, json_data):
    ...
    new_goalcheck = SupportGoalCheck(this_goal_id, check_id, created_by, created_at, comment)
...
@support_goals_api.doc(security='ApiKeyAuth', tags=['Support Goal Checks'], summary='Patch a check for a given goal from a given pupil')
@token_required
